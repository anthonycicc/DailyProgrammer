...
fun main(args: Array<String>) {
    PacketAssembler.assemblePacket(listOf<String>("6220    1   10  Because he's the hero Gotham deserves,",
            "6220    9   10",
    ...
    PacketAssembler.assemblePacket(listOf("7469    1   7   believe. Attack ships on fire off the",
